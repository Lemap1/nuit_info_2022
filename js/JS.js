...
events = {
        ...
        "3.5" : {
            "age" : 20,
            "desc" : "Vous avez tellement bu que vous vous effondrez. Vos amis sont dans le même état. Vous faites un coma éthyllique sans même vous en apercevoir.",
            "propal1" : "-1.alcool",
            "propal2" : "-1.alcool",
            "descL" : "suivant",
            "descR" : "suivant",
        ...
        "4" : {
            "age" : 25,
            "desc" : "Vous avez fini vos études, et vous recherchez la personne avec qui vous voulez passer votre vie.",
            "propal1" : "4.P",
            "propal2" : "4.A",
            "descL" : "suivant",
            "descR" : "suivant",
        ...
        "4.A.2" : {
            "age" : 25,
            "desc" : "Vous avez passé du bon temps sur les reseaux mais vous comptez arreter afin de trouver quelqu'un d'en votre vie",
            "propal1" : "4.A.1",
            "propal2" : "4.A.1",
            "descL" : "suivant",
            "descR" : "suivant",
        ...
        "-1.alcool" : {
            "age" : 20,
            "desc" : "Personne ne vous voit faire un Coma éthylique. Vous mourrez.",
            "propal1" : "end",
            "propal2" : "end",
            "descL" : "",
            "descR" : "",
...
function changeEvent(event){
        ...
        if(event == "f"){
            ...
            events["f"].desc = description + " Si vous n'aviez pas remarquer 'd' permet de se faire dépiseter"
        }
